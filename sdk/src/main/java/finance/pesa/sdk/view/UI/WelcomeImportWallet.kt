...
class WelcomeImportWallet : Fragment() {
    private var importWallet: Button? = null
    private var link: TextView? = null
    private var mobileNumber: String? = null

    companion object {
        fun newInstance(mobileNumber: String): WelcomeImportWallet {
            val fragment = WelcomeImportWallet()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.welcome_import_wallet, container, false)
        ...
        importWallet!!.setOnClickListener {
            ...
            PesaApplication.getChildFragmentManager()!!.beginTransaction()
                .add(
                    ...
                    ImportMnemonicFragment.newInstance(mobileNumber!!,false)
                ...
                try {
                    ...
                    if (isRight) {
                       /* PesaApplication.getChildFragmentManager()!!.beginTransaction().add(
                            R.id.shareg_main_container,
                            SignInPwdFragment.newInstance(mobileNumber!!)
